...
docker run --gpus=all --privileged -it -p 5000:5000/udp -p 7777:7777/udp -e DISPLAY=$DISPLAY -e ROS_DOMAIN_ID=$ROS_DOMAIN_ID -v /tmp/.X11-unix:/tmp/.X11-unix humble_neato
